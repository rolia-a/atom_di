            ...
            {[
              ...
              <div key={c.unit} className="flex items-start gap-2 md:gap-4">
                <div className="flex flex-col items-center">
                  <span className="text-5xl md:text-7xl lg:text-[86px] leading-none font-light tabular-nums">
                    {c.v}
                  </span>
                ...
                {i < arr.length - 1 && (
                  <span className="text-5xl md:text-7xl lg:text-[86px] leading-none font-light text-white/60">
                    :
                  </span>
                )}
              </div>
